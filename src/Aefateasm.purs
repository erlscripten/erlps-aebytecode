...
erlps__usage__0 [] =
  let    tup_el_6 = toErl "Fate assembler code file"
  in let
    head_1 =
      ErlangTuple
        [ErlangAtom "src_file", ErlangAtom "undefined",
         ErlangAtom "undefined", ErlangAtom "string", tup_el_6]
  in let tup_el_10 = toErl 118
  in let tup_el_11 = toErl "verbose"
  in let tup_el_13 = toErl "Verbose output"
  in let
    head_8 =
      ErlangTuple
        [ErlangAtom "verbose", tup_el_10, tup_el_11,
         ErlangAtom "undefined", tup_el_13]
  in let tup_el_17 = toErl 104
  in let tup_el_18 = toErl "help"
  in let tup_el_20 = toErl "Show this message"
  in let
    head_15 =
      ErlangTuple
        [ErlangAtom "help", tup_el_17, tup_el_18, ErlangAtom "undefined",
         tup_el_20]
  in let tup_el_24 = toErl 111
  in let tup_el_25 = toErl "out"
  in let tup_el_27 = toErl "Output file (experimental)"
  in let
    head_22 =
      ErlangTuple
        [ErlangAtom "outfile", tup_el_24, tup_el_25, ErlangAtom "string",
         tup_el_27]
  in let arg_29 = toErl "aefateasm"
  in
...
erlps__main__1 [args_0] =
  let    tup_el_8 = toErl "Fate assembler code file"
  in let
    head_3 =
      ErlangTuple
        [ErlangAtom "src_file", ErlangAtom "undefined",
         ErlangAtom "undefined", ErlangAtom "string", tup_el_8]
  in let tup_el_12 = toErl 118
  in let tup_el_13 = toErl "verbose"
  in let tup_el_15 = toErl "Verbose output"
  in let
    head_10 =
      ErlangTuple
        [ErlangAtom "verbose", tup_el_12, tup_el_13,
         ErlangAtom "undefined", tup_el_15]
  in let tup_el_19 = toErl 104
  in let tup_el_20 = toErl "help"
  in let tup_el_22 = toErl "Show this message"
  in let
    head_17 =
      ErlangTuple
        [ErlangAtom "help", tup_el_19, tup_el_20, ErlangAtom "undefined",
         tup_el_22]
  in let tup_el_26 = toErl 111
  in let tup_el_27 = toErl "out"
  in let tup_el_29 = toErl "Output file (experimental)"
  in let
    head_24 =
      ErlangTuple
        [ErlangAtom "outfile", tup_el_26, tup_el_27, ErlangAtom "string",
         tup_el_29]
  in let
    case_1 =
  ...
  in
    case case_1 of
      ...
      (ErlangTuple [(ErlangAtom "ok"),
        ...
        let    arg_39 = toErl "Can\'t understand ~p\n\n"
        in let
          _ =
  ...
  in
    case case_1 of
      (ErlangAtom "undefined") ->
        let    arg_5 = toErl "Error: no input source file\n\n"
        in let
          _ = BIF.do_remote_fun_call "Erlang.Io" "erlps__format__1" [arg_5]
        in erlps__usage__0 []
