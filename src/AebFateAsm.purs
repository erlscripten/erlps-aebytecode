...
erlps__assemble_file__3 [infile_0, outfile_1, options_2] =
  ...
  in let matchExpr_9 = erlps__asm_to_bytecode__2 [asm_4, options_2]
  in
    case matchExpr_9 of
...
erlps__parse_function_call__1 [(ErlangCons (ErlangTuple [(ErlangAtom "id"),
                                                         ...
                                                         name_0]) (ErlangCons (ErlangTuple [(ErlangAtom "("),
                                                                                            _]) rest_1))]
  =
  let matchExpr_4 = erlps__to_args__1 [rest_1]
  in
    case matchExpr_4 of
      (ErlangTuple [args_3, (ErlangEmptyList)]) ->
        ...
        in let tup_el_10 = ErlangTuple [ErlangAtom "tuple", tup_el_12]
...
erlps__parse_function_call__1 [arg_14] = EXC.function_clause unit
  ...
  in
    case case_1 of
      (ErlangTuple [arg_3,
        ...
        let matchExpr_8 = erlps__to_args__1 [rest_4]
        in
          case matchExpr_8 of
...
erlps__to_asm__1 [fatecode_0] =
  ...
  in erlps__insert_comments__3 [arg_7, arg_9, arg_10]
...
erlps__insert_comments__3 [(ErlangCons (ErlangTuple [l_0,
  ...
  in let arg_12 = BIF.erlang__op_plus [l_0, rop_14]
  in let
    rop_10 = erlps__insert_comments__3 [comments_2, arg_12, string_4]
...
erlps__insert_comments__3 [comments_0, l_1,
  ...
  =
  let tail_5 = erlps__insert_comments__3 [comments_0, l_1, rest_3]
...
erlps__insert_comments__3 [(ErlangCons (ErlangTuple [l_0,
  ...
  in let arg_10 = BIF.erlang__op_plus [l_0, rop_12]
  in let
    rop_8 =
...
erlps__format_functions__2 [functions_0, symbols_1] =
  let lcSrc_2 = BIF.maps__to_list__1 [functions_0]
  in
    flmap
      (\ lc_8 ->
         case lc_8 of
           (ErlangTuple [name_4,
             ...
             in let
               arg_14 = BIF.do_remote_fun_call "Lists" "erlps__sort__1" [arg_15]
             in let
               lcRet_9 = erlps__format__4 [arg_10, sig_6, arg_14, symbols_1]
...
erlps__format_arg_types__1 [(ErlangEmptyList)] = toErl ""
...
erlps__format_bbs__2 [arg_16, arg_17] = EXC.function_clause unit
erlps__format_bbs__2 args =
  EXC.badarity (ErlangFun 2 (\ _ -> ErlangAtom "purs_tco_sucks"))
    args

erlps__format_code__2 :: ErlangFun
erlps__format_code__2 [(ErlangEmptyList), _] = toErl ""
...
erlps__format_code__2 [arg_15, arg_16] = EXC.function_clause unit
      ...
      (ErlangTuple [(ErlangAtom "ok"), tokens_3, _]) ->
        ...
        in let
          env_16 =
            ErlangMap
              (Map.fromFoldable
                 [DT.Tuple (ErlangAtom "fate_code") val_14,
                  DT.Tuple (ErlangAtom "functions") val_15])
        in let
          env1_22 =
            erlps__to_bytecode__5
              [tokens_3, ErlangAtom "none", env_16, ErlangEmptyList, options_1]
        in let
          fatecode_25 = BIF.maps__get__2 [ErlangAtom "fate_code", env1_22]
        in let
          functionsmap_28 =
        ...
        in let
          functions_35 =
            flmap
              ...
              lcSrc_29
        in let
          functionsbin_37 = BIF.erlang__iolist_to_binary__1 [functions_35]
        in let
          bytecode_41 =
...
erlps__to_bytecode__5 [(ErlangCons (ErlangTuple [(ErlangAtom "function"),
  ...
  in let matchExpr_13 = erlps__to_fun_def__1 [rest_1]
  in
...
erlps__to_bytecode__5 [(ErlangCons (ErlangTuple [(ErlangAtom "stack"),
  ...
  in let head_10 = ErlangTuple [ErlangAtom "stack", tup_el_12]
  in
    erlps__to_bytecode__5
        ...
        in let
          tuple_12 =
            BIF.do_remote_fun_call "Aeb.Fate.Data" "erlps__make_tuple__1"
              [arg_10]
        in let head_17 = ErlangTuple [ErlangAtom "immediate", tuple_12]
        in
          erlps__to_bytecode__5
  ...
  in
    case matchExpr_11 of
      (ErlangTuple [arities_7, tag_8, values_9, rest_10]) ->
        ...
        in let head_20 = ErlangTuple [ErlangAtom "immediate", variant_15]
        in
          erlps__to_bytecode__5
        ...
        let   
          typerep_11 =
            BIF.do_remote_fun_call "Aeb.Fate.Data" "erlps__make_typerep__1"
              [type_7]
        in let head_16 = ErlangTuple [ErlangAtom "immediate", typerep_11]
        in
          erlps__to_bytecode__5
...
erlps__parse_map__1 [tokens_0] =
  let matchExpr_4 = erlps__parse_value__1 [tokens_0]
  in
    case matchExpr_4 of
      (ErlangTuple [key_2,
                    (ErlangCons (ErlangTuple [(ErlangAtom "arrow"),
                                              _]) rest_3)]) ->
        let matchExpr_8 = erlps__parse_value__1 [rest_3]
        in
          case matchExpr_8 of
            (ErlangTuple [value_6, rest2_7]) ->
              case rest2_7 of
                (ErlangCons (ErlangTuple [(ErlangAtom ","), _]) rest3_10) ->
                  let matchExpr_14 = erlps__parse_map__1 [rest3_10]
                  in
                    case matchExpr_14 of
                      (ErlangTuple [map_12, rest4_13]) ->
                        let   
                          mapExt_19 = ErlangMap (Map.singleton key_2 value_6)
                        in let
                          tup_el_15 = BIF.maps__merge__2 [map_12, mapExt_19]
      ...
      (ErlangTuple [head_2, rest_3]) ->
        case rest_3 of
          (ErlangCons (ErlangTuple [(ErlangAtom ","), _]) rest2_6) ->
            let matchExpr_10 = erlps__parse_list__1 [rest2_6]
            in
  ...
  in
    case matchExpr_4 of
      (ErlangTuple [head_2, rest_3]) ->
        case rest_3 of
          (ErlangCons (ErlangTuple [(ErlangAtom ","), _]) rest2_6) ->
            let matchExpr_10 = erlps__parse_tuple__1 [rest2_6]
            in
              case matchExpr_10 of
                (ErlangTuple [tail_8, rest3_9]) ->
                  ErlangTuple [ErlangCons head_2 tail_8, rest3_9]
            ...
            flmap
              (\ lc_9 ->
                 ...
                 in
                   case cond_10 of
                     (ErlangAtom "true") ->
                       let    rop_14 = toErl 256
                       in let cond_12 = BIF.erlang__op_lesser [lc_9, rop_14]
                       in
                         case cond_12 of
                           (ErlangAtom "true") ->
                              ...
                              in
                                case ErlangAtom "true" of
                                  _ | ((ErlangAtom "true") ==
                                    ...
                                    in
                                      ErlangTuple
                                        [arities_4, tag_19, tup_el_38, rest4_24]
...
erlps__parse_value__1 [(ErlangCons (ErlangTuple [(ErlangAtom "("),
                                                 _line_0]) rest_1)]
  =
  let matchExpr_5 = erlps__parse_tuple__1 [rest_1]
  in
    case matchExpr_5 of
...
erlps__parse_value__1 [tokens_1@(ErlangCons (ErlangTuple [(ErlangAtom "start_variant"),
                                                          _line_0]) _)]
  =
  let matchExpr_7 = erlps__parse_variant__1 [tokens_1]
  in
    case matchExpr_7 of
...
erlps__to_fun_def__1 [(ErlangCons (ErlangTuple [(ErlangAtom "id"),
                                                ...
                                                name_0]) (ErlangCons (ErlangTuple [(ErlangAtom "("),
                                                                                   _]) rest_1))]
  =
  let matchExpr_5 = erlps__to_arg_types__1 [rest_1]
  in
    case matchExpr_5 of
      (ErlangTuple [argstype_3,
                    (ErlangCons (ErlangTuple [(ErlangAtom "to"),
                                              _]) rest2_4)]) ->
        let matchExpr_9 = erlps__to_type__1 [rest2_4]
        in
          case matchExpr_9 of
...
erlps__to_arg_types__1 [tokens_0] =
  ...
  in
    case case_1 of
      (ErlangTuple [type_3,
                    (ErlangCons (ErlangTuple [(ErlangAtom ","), _]) rest_4)]) ->
        let matchExpr_8 = erlps__to_arg_types__1 [rest_4]
        in
          case matchExpr_8 of
  ...
  in
    case matchExpr_9 of
      (ErlangTuple [elementtypes_7,
                    (ErlangCons (ErlangTuple [(ErlangAtom "}"),
                                              _]) rest2_8)]) ->
        let tup_el_10 = ErlangTuple [ErlangAtom "tuple", elementtypes_7]
  ...
  in
    case matchExpr_7 of
      (ErlangTuple [keytype_5,
                    (ErlangCons (ErlangTuple [(ErlangAtom ","),
                                              _]) rest2_6)]) ->
        let matchExpr_11 = erlps__to_type__1 [rest2_6]
        in
          case matchExpr_11 of
    ...
    case matchExpr_11 of
      (ErlangTuple [elementtypes_9,
                    (ErlangCons (ErlangTuple [(ErlangAtom "}"),
                                              _]) rest2_10)]) ->
        let
          tup_el_12 = ErlangTuple [ErlangAtom "variant", elementtypes_9]
...
erlps__to_list_of_types__1 [tokens_0] =
  ...
  in
    case case_1 of
      (ErlangTuple [type_3,
                    (ErlangCons (ErlangTuple [(ErlangAtom ","), _]) rest_4)]) ->
        let matchExpr_8 = erlps__to_list_of_types__1 [rest_4]
        in
          case matchExpr_8 of
            (ErlangTuple [moretypes_6, rest2_7]) ->
              ErlangTuple [ErlangCons type_3 moretypes_6, rest2_7]
...
erlps__insert_fun__3 [(ErlangTuple [namestring_0, argtype_1,
  ...
  | (DM.Just funs_6) <- (Map.lookup (ErlangAtom "functions") map_4)
  , (DM.Just fatecode_5) <-
  ...
  in
    case matchExpr_14 of
      (ErlangTuple [fatecode1_12, id_13]) ->
        ...
        in let
          bodybytecode_17 =
            BIF.do_remote_fun_call "Aeb.Fate.Code" "erlps__serialize_code__1"
              [arg_15]
        ...
        in let val_37 = BIF.maps__merge__2 [funs_6, mapExt_41]
        in let
          mapExt_44 =
            ErlangMap
              (Map.fromFoldable
                 [DT.Tuple (ErlangAtom "functions") val_37,
                  DT.Tuple (ErlangAtom "fate_code") fatecode1_12])
        in BIF.maps__merge__2 [env_7, mapExt_44]
      _ -> EXC.badmatch matchExpr_14
  ...
  in
    case matchExpr_8 of
      (ErlangTuple [fatecode1_6, id_7]) ->
        ...
        in let tup_el_9 = BIF.maps__merge__2 [env_3, mapExt_13]
...
erlps__insert_annotation__4 [(ErlangAtom "comment"), line_0,
  ...
  in BIF.maps__merge__2 [env_4, mapExt_13]
...
erlps__mk_hash__1 [id_0] =
  let    arg_1 = toErl 32
  in let arg_2 = BIF.erlang__list_to_binary__1 [id_0]
  in let
    matchExpr_17 =
  ...
  in
    case matchExpr_17 of
      (ErlangTuple [(ErlangAtom "ok"),
                    (ErlangBinary binSeg_4)]) | (ErlangInt size_5) <- (toErl 8)
                                              , (BIN.Ok a_7 bin_6) <-
                                                  (BIN.chopInt binSeg_4 size_5 1
                                                     BIN.Big BIN.Unsigned)
                                              , (ErlangInt size_8) <- (toErl 8)
                                              , (BIN.Ok b_10 bin_9) <-
                                                  (BIN.chopInt bin_6 size_8 1
                                                     BIN.Big BIN.Unsigned)
                                              , (ErlangInt size_11) <- (toErl 8)
                                              , (BIN.Ok c_13 bin_12) <-
                                                  (BIN.chopInt bin_9 size_11 1
                                                     BIN.Big BIN.Unsigned)
                                              , (ErlangInt size_14) <- (toErl 8)
                                              , (BIN.Ok d_16 bin_15) <-
                                                  (BIN.chopInt bin_12 size_14 1
                                                     BIN.Big BIN.Unsigned) ->
        ErlangBinary
          (BIN.concat
             [BIN.fromInt a_7 (toErl 8) 1 BIN.Big,
              BIN.fromInt b_10 (toErl 8) 1 BIN.Big,
              BIN.fromInt c_13 (toErl 8) 1 BIN.Big,
              BIN.fromInt d_16 (toErl 8) 1 BIN.Big])
      _ -> EXC.badmatch matchExpr_17
...
erlps__get_comments__1 [annotations_0] =
  let lcSrc_1 = BIF.maps__to_list__1 [annotations_0]
  in
    flmap
      (\ lc_12 ->
         case lc_12 of
