...
erlps__tag__1 [(ErlangAtom "name_commitment")] =
  (ErlangInt (DBI.fromInt 31))
erlps__tag__1 [(ErlangAtom "name_claim_tx")] =
  (ErlangInt (DBI.fromInt 32))
erlps__tag__1 [(ErlangAtom "name_preclaim_tx")] =
  (ErlangInt (DBI.fromInt 33))
erlps__tag__1 [(ErlangAtom "name_update_tx")] =
  (ErlangInt (DBI.fromInt 34))
erlps__tag__1 [(ErlangAtom "name_revoke_tx")] =
  (ErlangInt (DBI.fromInt 35))
erlps__tag__1 [(ErlangAtom "name_transfer_tx")] =
  (ErlangInt (DBI.fromInt 36))
erlps__tag__1 [(ErlangAtom "name_auction")] =
  (ErlangInt (DBI.fromInt 37))
erlps__tag__1 [(ErlangAtom "contract")] =
  (ErlangInt (DBI.fromInt 40))
erlps__tag__1 [(ErlangAtom "contract_call")] =
  (ErlangInt (DBI.fromInt 41))
erlps__tag__1 [(ErlangAtom "contract_create_tx")] =
  (ErlangInt (DBI.fromInt 42))
erlps__tag__1 [(ErlangAtom "contract_call_tx")] =
  (ErlangInt (DBI.fromInt 43))
erlps__tag__1 [(ErlangAtom "channel_create_tx")] =
  (ErlangInt (DBI.fromInt 50))
erlps__tag__1 [(ErlangAtom "channel_deposit_tx")] =
  (ErlangInt (DBI.fromInt 51))
erlps__tag__1 [(ErlangAtom "channel_withdraw_tx")] =
  (ErlangInt (DBI.fromInt 52))
erlps__tag__1 [(ErlangAtom "channel_force_progress_tx")] =
  (ErlangInt (DBI.fromInt 521))
erlps__tag__1 [(ErlangAtom "channel_close_mutual_tx")] =
  (ErlangInt (DBI.fromInt 53))
erlps__tag__1 [(ErlangAtom "channel_close_solo_tx")] =
  (ErlangInt (DBI.fromInt 54))
erlps__tag__1 [(ErlangAtom "channel_slash_tx")] =
  (ErlangInt (DBI.fromInt 55))
erlps__tag__1 [(ErlangAtom "channel_settle_tx")] =
  (ErlangInt (DBI.fromInt 56))
erlps__tag__1 [(ErlangAtom "channel_offchain_tx")] =
...
erlps__tag__1 [(ErlangAtom "channel")] =
  (ErlangInt (DBI.fromInt 58))
erlps__tag__1 [(ErlangAtom "channel_snapshot_solo_tx")] =
  (ErlangInt (DBI.fromInt 59))
erlps__tag__1 [(ErlangAtom "trees_poi")] =
  (ErlangInt (DBI.fromInt 60))
erlps__tag__1 [(ErlangAtom "trees_db")] =
  (ErlangInt (DBI.fromInt 61))
erlps__tag__1 [(ErlangAtom "state_trees")] =
  (ErlangInt (DBI.fromInt 62))
erlps__tag__1 [(ErlangAtom "mtree")] =
  (ErlangInt (DBI.fromInt 63))
erlps__tag__1 [(ErlangAtom "mtree_value")] =
  (ErlangInt (DBI.fromInt 64))
erlps__tag__1 [(ErlangAtom "contracts_mtree")] =
  (ErlangInt (DBI.fromInt 621))
erlps__tag__1 [(ErlangAtom "calls_mtree")] =
  (ErlangInt (DBI.fromInt 622))
erlps__tag__1 [(ErlangAtom "channels_mtree")] =
  (ErlangInt (DBI.fromInt 623))
erlps__tag__1 [(ErlangAtom "nameservice_mtree")] =
  (ErlangInt (DBI.fromInt 624))
erlps__tag__1 [(ErlangAtom "oracles_mtree")] =
  (ErlangInt (DBI.fromInt 625))
erlps__tag__1 [(ErlangAtom "accounts_mtree")] =
  (ErlangInt (DBI.fromInt 626))
erlps__tag__1 [(ErlangAtom "compiler_sophia")] =
  (ErlangInt (DBI.fromInt 70))
erlps__tag__1 [(ErlangAtom "ga_attach_tx")] =
  (ErlangInt (DBI.fromInt 80))
erlps__tag__1 [(ErlangAtom "ga_meta_tx")] =
  (ErlangInt (DBI.fromInt 81))
erlps__tag__1 [(ErlangAtom "key_block")] =
  (ErlangInt (DBI.fromInt 100))
erlps__tag__1 [(ErlangAtom "micro_block")] =
  (ErlangInt (DBI.fromInt 101))
erlps__tag__1 [(ErlangAtom "light_micro_block")] =
  (ErlangInt (DBI.fromInt 102))
erlps__tag__1 [(ErlangAtom "pof")] =
