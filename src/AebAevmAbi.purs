...
erlps__create_calldata__4 [funname_0, args_1, argtypes0_2,
                           rettype_3]
  =
  let    argtypes_6 = ErlangTuple [ErlangAtom "tuple", argtypes0_2]
  ...
  in
    case matchExpr_15 of
      (ErlangBinary binSeg_11) | (ErlangInt size_12) <- (toErl 32)
                               , (BIN.Ok typehashint_14 bin_13) <-
                                   (BIN.chopInt binSeg_11 size_12 8 BIN.Big
                                      BIN.Unsigned)
                               , BIN.empty bin_13 ->
        ...
        in let
          data_20 =
            BIF.do_remote_fun_call "Aeb.Heap" "erlps__to_binary__1" [arg_16]
  ...
  in
    case case_3 of
      ...
      (ErlangTuple [(ErlangAtom "error"), _what_10]) ->
        ErlangTuple [ErlangAtom "error", ErlangAtom "bad_call_data"]
  ...
  in
    case case_1 of
      (ErlangTuple [(ErlangAtom "ok"), (ErlangTuple [hashint_8])]) ->
        let
          tup_el_10 =
            ErlangBinary (BIN.fromInt hashint_8 (toErl 32) 8 BIN.Big)
...
erlps__function_type_info__4 [name_0, payable_1, argtypes_2,
                              outtype_3]
  =
  let    argtype_6 = ErlangTuple [ErlangAtom "tuple", argtypes_2]
  in let
    tup_el_7 =
...
erlps__arg_typerep_from_function__2 [function_0, typeinfo_1] =
  let    arg_4 = toErl 2
  in let
    case_2 = BIF.lists__keyfind__3 [function_0, arg_4, typeinfo_1]
  in
    case case_2 of
  ...
  in
    case case_1 of
      (ErlangTuple [(ErlangAtom "ok"), argt_4]) ->
        ErlangTuple [ErlangAtom "ok", argt_4]
      (ErlangTuple [(ErlangAtom "error"), _]) ->
        ErlangTuple [ErlangAtom "error", ErlangAtom "bad_type_data"]
      something_else -> EXC.case_clause something_else
...
erlps__typereps_from_type_hash__2 [typehash_0, typeinfo_1] =
  let    arg_4 = toErl 1
  in let
    case_2 = BIF.lists__keyfind__3 [typehash_0, arg_4, typeinfo_1]
  in
    case case_2 of
...
erlps__type_hash_from_function_name__2 [name_0, typeinfo_1] =
  let    arg_4 = toErl 2
  in let case_2 = BIF.lists__keyfind__3 [name_0, arg_4, typeinfo_1]
  in
    case case_2 of
  ...
  in
    case case_2 of
      ...
      (ErlangAtom "false") ->
        ErlangTuple [ErlangAtom "error", ErlangAtom "unknown_function"]
      something_else -> EXC.case_clause something_else
erlps__is_payable__2 [arg_21, arg_22] = EXC.function_clause unit
