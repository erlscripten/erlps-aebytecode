  ...
  in
    EXC.tryOfCatch
      (\ _ ->
         ...
         in let arg_5 = BIF.erlang__element__2 [arg_6, arg_7]
      ...
      (\ of_9 ->
         case of_9 of
           ...
           _ -> ErlangTuple [ErlangAtom "error", ErlangAtom "decode_error"])
      (\ ex_10 ->
         case ex_10 of
           (ErlangTuple [_, _, _]) ->
...
erlps__get_function_name_from_function_hash__2 [(ErlangBinary binSeg_0),
                                                fatecode_6]
  | (ErlangInt size_1) <- (toErl 4)
  , (BIN.Ok symbolhash_3 bin_2) <- (BIN.chopBin binSeg_0 size_1 8)
  , (ErlangInt size_4) <- (toErl 28)
  , (BIN.Ok _ bin_5) <- (BIN.chopBin bin_2 size_4 8)
  , BIN.empty bin_5 =
  erlps__get_function_name_from_function_hash__2
    [symbolhash_3, fatecode_6]
erlps__get_function_name_from_function_hash__2 [symbolhash_3@(ErlangBinary binSeg_0),
                                                fatecode_4]
  | (ErlangInt size_1) <- (toErl 4)
  , (BIN.Ok _ bin_2) <- (BIN.chopBin binSeg_0 size_1 8)
  , BIN.empty bin_2 =
  let   
    symbols_6 =
...
erlps__get_function_hash_from_calldata__1 [calldata_0] =
  EXC.tryOfCatch
    (\ _ ->
       ...
       in let arg_1 = BIF.erlang__element__2 [arg_2, arg_3]
    ...
    (\ of_5 ->
       case of_5 of
         ...
         _ -> ErlangTuple [ErlangAtom "error", ErlangAtom "bad_calldata"])
    (\ ex_6 ->
       case ex_6 of
         (ErlangTuple [_, _, _]) ->
...
erlps__get_function_type_from_function_hash__2 [(ErlangBinary binSeg_0),
                                                fatecode_6]
  | (ErlangInt size_1) <- (toErl 4)
  , (BIN.Ok symbolhash_3 bin_2) <- (BIN.chopBin binSeg_0 size_1 8)
  , (ErlangInt size_4) <- (toErl 28)
