...
erlps__type2enc__1 [(ErlangAtom "contract_store_value")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "transaction")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "tx_hash")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "oracle_pubkey")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "oracle_query")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "oracle_query_id")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "oracle_response")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "account_pubkey")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "signature")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "commitment")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "peer_pubkey")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "name")] =
  (ErlangInt (DBI.fromInt 1))
erlps__type2enc__1 [(ErlangAtom "state")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "poi")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "state_trees")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "call_state_tree")] =
  (ErlangInt (DBI.fromInt 2))
erlps__type2enc__1 [(ErlangAtom "bytearray")] =
  (ErlangInt (DBI.fromInt 2))
